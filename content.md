To include a hyperlink in an HTML document, you use the `<a>` tag. For example:

```html
<a href="https://www.imperial.ac.uk">Imperial College London</a>
```

This will render as "<a href="https://www.imperial.ac.uk">Imperial College London</a>". The text within the tags is the link text that will be displayed to the user. The `href` attribute specifies the URL of the page the link goes to.
